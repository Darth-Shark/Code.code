...
public class Dragon{
    ...
    public void setBreath(String newBreath){//Method to change breath weapon type.
        ...
        if(newBreath=="fire" || newBreath=="ice" || newBreath=="dark" || newBreath=="green fire" || newBreath=="blue fire" || newBreath=="frost" || newBreath=="hoarfrost" || newBreath=="purple fire"){
...
public void flyToggle(){//Toggles boolean isFlying.
    ...
    public void breathe(){// Funtion for breath attack. Returns attack type and damage.
        ...
        else if(breathType=="green fire" || breathType=="blue fire" || breathType=="purple fire"){//Colered fire is a flat upgrade from normal fire, but it can't be used by weak dragons.
            if(attackPwr>=10){
        ...
        else if(breathType=="frost"){//Frost is a more powerful version of ice, hoarfrost is another step up from that. Niether can be used by weak dragons.
            if(attackPwr>=10){
                System.out.println(name + " chills the enemy with their " + breathType + " breath!");
                dmg = attackPwr + 15;
            }
